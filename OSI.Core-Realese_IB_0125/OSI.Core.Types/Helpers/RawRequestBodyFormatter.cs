    ...
    public class RawRequestBodyFormatter : InputFormatter
    {
        ...
        public override bool CanRead(InputFormatterContext context)
        {
            ...
            if ((context.ModelType == typeof(string) && 
                (string.IsNullOrEmpty(contentType) || contentType == "text/plain" || MediaTypeHeaderValue.Parse(contentType).MediaType == "text/plain"))
                ||
                (context.ModelType == typeof(byte[]) && contentType == "application/octet-stream"))
                return true;
        ...
        public override async Task<InputFormatterResult> ReadRequestBodyAsync(InputFormatterContext context)
        {
            ...
            if (string.IsNullOrEmpty(contentType) || contentType == "text/plain" 
                || MediaTypeHeaderValue.Parse(contentType).MediaType == "text/plain")
            {
